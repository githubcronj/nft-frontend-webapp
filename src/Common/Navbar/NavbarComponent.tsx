...
const NavbarComponent: FC<nav> = ({ connected, setConnected }) => {
  ...
  console.log("Test Navbar id --> ", address?.substring(0, 5));
      ...
      <Container>
        <Toolbar disableGutters>
          <Link to="/home">
            ...
            <img src={cronjLogo} alt="logo" className={`${classes.logo}`} />
          </Link>
          ...
          >
            ...
            >
              ...
              <Link
                to={address ? "/upload" : "/wallet-connect"}
              ...
              <Link
                to={address ? "/listing" : "/wallet-connect"}
                className="linkUnderline"
              >
                <ButtonComponent btnColor={"#3772FF"} classNames="styleUp">
                  Listings
            ...
            {address ? (
              ...
              >
                ...
                <ProfileCard price={address?.substring(0, 5) + " ETH"} />
              </Box>
            ) : (
              <Box
                component="span"
            ...
            >
              <ProfileCard price="7.7565 ETH" />
              <ProfileCard price={account?.substring(0, 5) + " ETH"} />
              <ProfileCard price={"Profile"} />
            </Box> */}
